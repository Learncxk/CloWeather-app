// CloWeather API — 天气预报 /api/forecast?lat=xx&lon=xx
...
export default async (req, res) => {
  ...
  try {
    const data = await fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&units=metric&lang=zh_cn&appid=${API_KEY}`).then(r => r.json());
